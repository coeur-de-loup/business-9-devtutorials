export default function Footer() {
  const footerLinks = {
    Product: ['Browse Tutorials', 'Learning Paths', 'For Creators', 'Pricing', 'Bundle Deals'],
    Company: ['About Us', 'Blog', 'Careers', 'Press Kit', 'Contact'],
    Resources: ['FAQ', 'Support Center', 'Community Forum', 'Developer Discord', 'Creator Guidelines'],
    Legal: ['Terms of Service', 'Privacy Policy', 'Creator Agreement', 'Refund Policy', 'Cookie Policy'],
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-slate-800 rounded-xl p-8 mb-12 border border-slate-700">
          <div className="max-w-2xl mx-auto text-center">
            <h3 className="text-xl font-bold text-white mb-2">Stay Fresh. Get Weekly Tutorial Updates.</h3>
            <p className="text-sm mb-4">Join 12,000+ developers. No spam, just fresh tutorials.</p>
            <div className="flex gap-2 max-w-md mx-auto">
              <input
                type="email"
                placeholder="Enter your email"
                className="flex-1 px-4 py-2 rounded-lg bg-slate-900 border border-slate-700 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
        ...
        <div className="border-t border-slate-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-sm">
              © 2026 DevTutorials. All rights reserved.
            </p>

            <p className="text-sm">
              Made with <span className="text-red-500">❤️</span> for intermediate developers everywhere.
            </p>
          </div>
